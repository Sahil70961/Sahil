...
bot = telebot.TeleBot('7028032358:AAHajOCDql6FsJOL2s4HxgDv7iw1MnyyXLI')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access!🚫Please buy access :-@offx_sahil"
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''
1. ANY PROBLEM DM HERE -> @offx_sahil'''
    bot.reply_to(message, response)
